...
object kafkaCostumerApi {
  def main(args: Array[String]) {
    //val spark = SparkSession.builder.master("local[*]").appName("kafkaCostumerApi").config("spark.sql.warehouse.dir", "/home/hadoop/work/warehouse").enableHiveSupport().getOrCreate()
    ...
    lines.foreachRDD { rdd =>
      ...
      // Save data into oracle DB
       ...
       res.write.mode(SaveMode.Append).jdbc(host,"kafkalog",prop)*/
      //res.show()
    }
